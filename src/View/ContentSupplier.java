 ...
 * @author enigma
 */
public class ContentSupplier extends javax.swing.JInternalFrame {
    ...
    private void LoadData() {
        ...
        var data = Model.Supplier.Get();
        var rows = new Object[7];
        for (HashMap<String, String> item : data) {
            rows[0] = item.get("id");
            rows[1] = item.get("nama");
            rows[2] = item.get("alamat");
            rows[3] = item.get("telepon");
            rows[4] = item.get("email");
            rows[5] = item.get("website");
            rows[6] = item.get("deskripsi");
            model.addRow(rows);
        }
    }
    ...
    private void initComponents() {
        ...
        lblWebsite.setFont(new java.awt.Font("Tw Cen MT", 1, 18)); // NOI18N
        lblWebsite.setForeground(new java.awt.Color(67, 76, 94));
        lblWebsite.setText("Website");
        lblWebsite.setMaximumSize(new java.awt.Dimension(117, 40));
        lblWebsite.setMinimumSize(new java.awt.Dimension(117, 40));
        lblWebsite.setPreferredSize(new java.awt.Dimension(117, 40));

        fieldWebsite.setBackground(new java.awt.Color(76, 86, 106));
        fieldWebsite.setFont(new java.awt.Font("Tw Cen MT", 1, 18)); // NOI18N
        fieldWebsite.setForeground(new java.awt.Color(255, 255, 255));
        fieldWebsite.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(76, 86, 106), 10));
        fieldWebsite.setMargin(new java.awt.Insets(10, 10, 10, 10));
        fieldWebsite.setMinimumSize(new java.awt.Dimension(64, 40));
        fieldWebsite.setOpaque(true);
        fieldWebsite.setPreferredSize(new java.awt.Dimension(101, 40));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblTelepon, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(lblNama, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(fieldEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(fieldTelepon, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(58, 58, 58)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(lblWebsite, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jScrollPane3)
                            .addComponent(fieldWebsite, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        TableSupplier.setBackground(new java.awt.Color(236, 239, 244));
        TableSupplier.setFont(new java.awt.Font("Tw Cen MT", 1, 14)); // NOI18N
        TableSupplier.setForeground(new java.awt.Color(76, 86, 106));
        TableSupplier.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Nama Supplier", "Alamat", "Nomor Telepon", "Email", "Website", "Deskripsi"
            }
        ) {
        ...
        TableSupplier.setToolTipText("");
        TableSupplier.setDoubleBuffered(true);
        TableSupplier.setFocusable(false);
        TableSupplier.setGridColor(new java.awt.Color(67, 76, 94));
        TableSupplier.setRowHeight(30);
        TableSupplier.setSelectionBackground(new java.awt.Color(216, 222, 233));
        TableSupplier.setSelectionForeground(new java.awt.Color(67, 76, 94));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        var website = fieldWebsite.getText();
        var deskripsi = fieldDeskripsi.getText();
        Model.Supplier.Add(nama, alamat, telepon, email, website, deskripsi);
        this.ClearData();
        this.LoadData();
        this.FieldClear();
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        ...
        var website = fieldWebsite.getText();
        var deskripsi = fieldDeskripsi.getText();
        Model.Supplier.Edit(key, nama, alamat, telepon, email, website, deskripsi);
        this.ClearData();
        this.LoadData();
        this.FieldClear();
    ...
    private void TableSupplierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableSupplierMouseClicked
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) TableSupplier.getModel();
        int idx = TableSupplier.getSelectedRow();
        ...
        fieldWebsite.setText(model.getValueAt(idx, 5).toString());
        fieldDeskripsi.setText(model.getValueAt(idx, 6).toString());
    ...
    private javax.swing.JTextField fieldWebsite;
